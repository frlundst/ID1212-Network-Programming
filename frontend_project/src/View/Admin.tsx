...
interface AdminProps {
    ...
    onAddProductSale: (event: any) => void;
}
...
function Admin(props: AdminProps) {
    return <Wrapper>
        ...
        <hr />
        <h2>Insert sale</h2>
        <Form style={{ width: "50%" }} onSubmit={props.onAddProductSale}>
            <Form.Group controlId="saleProductName" >
                <Form.Label>Product name</Form.Label>
                <Form.Control type="text" placeholder="Enter product name" />
            </Form.Group>
            <Form.Group controlId="saleDiscount">
